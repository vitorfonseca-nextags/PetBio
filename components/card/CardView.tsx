...
export function CardView({ card }: { card: CardComPedido }) {
  ...
  return (
    <main className="moldura-desktop relative mx-auto min-h-screen w-full max-w-md bg-cream pb-10">
      {card.is_watermarked && <MarcaDagua />}

      <div className="sticky top-0 z-10 flex items-center justify-between border-b border-line bg-cream/90 px-4 py-3 backdrop-blur sm:rounded-t-[32px]">
